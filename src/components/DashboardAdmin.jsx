...
function DashboardAdmin() {
  ...
  const [pilihStruktur, setPilihStruktur] = useState(false);

  const handleKepalaLab = () => {
    setPilihStruktur(true);
  };

  const handleAsisten = () => {
    setPilihStruktur(false);
  };
    ...
    <>
                ...
                <li className="navbar-sb-link my-3">
                  ...
                  >
                    <div className="text-light-blue d-flex align-items-center">
                      ...
                      <span
                        className="navbar-sb-text fs-14 fw-5 text-capitalize"
                        onClick={handleAsisten}
                      >
                        Asisten Aktif
                      </span>
                    </div>
      ...
      <div className="dashboard-main bg-bluegrad pb-5">
        <div className="container">
          ...
          {pilihStruktur ? <KepalaLab /> : <AsistenAktif />}
        </div>
      </div>
    </>
  );
