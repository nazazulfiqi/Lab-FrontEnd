                ...
                <div class="overview-section-item bg-white p-4">
                  ...
                  <div class="item-bottom d-flex align-items-center justify-content-between">
                    <div class="earnings me-3">
                      ...
                      <span class="fs-15">
                        Earned <span class="text-cyan">R0</span> today{" "}
                      </span>
                    </div>
                    <div class="deposit">
                      <span>
                ...
                <div class="overview-section-item bg-white p-4">
                  ...
                  <div class="item-bottom d-flex align-items-center justify-content-between">
                    <div class="earnings me-3">
                      ...
                      <span class="fs-15">
                        Earned <span class="text-cyan">45</span> until rank
                        expires{" "}
                      </span>
                    </div>
                    <span class="balance-icon align-self-end fs-20">
                  ...
                  <div class="item-bottom d-flex align-items-center justify-content-between">
                    <div class="earnings me-3">
                      <span class="text-grey">
                        You have{" "}
                        <span class="text-grey-blue">2 downlines </span>
                        <span class="text-blue">Withdraw</span>
                      </span>
                    </div>
                    <button
                      type="button"
                      class="btn-outline-sm text-blue d-block mt-2 px-2"
                    >
                      Copy referral link
                    </button>
                  </div>
